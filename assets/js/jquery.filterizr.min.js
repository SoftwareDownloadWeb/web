    ...
    c.prototype={
        ...
        fit:function(a){
            ...
            for(this.root.h=f,b=0;b<e;b++)
                d=a[b], (c=this.findNode(this.root,d.w,d.h))?d.fit=this.splitNode(c,d.w,d.h):d.fit=this.growDown(d.w,d.h)
        },
